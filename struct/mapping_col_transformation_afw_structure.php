...
class EtlMappingColTransformationAfwStructure
 {
    // token separator = §
    public static function initInstance( &$obj )
 {
        if ( $obj instanceof MappingColTransformation ) 
 {
            $obj->QEDIT_MODE_NEW_OBJECTS_DEFAULT_NUMBER = 15;
            $obj->DISPLAY_FIELD_BY_LANG = [ 'ar'=>'name_ar', 'en'=>'name_en' ];

            // $obj->ENABLE_DISPLAY_MODE_IN_QEDIT = true;
            $obj->ORDER_BY_FIELDS = 'mapping_col_id, transformation_order';

            $obj->UNIQUE_KEY = array( 'mapping_col_id', 'transformation_order' );
            $obj->OwnedBy = array('module' => "etl", 'afw' => "MappingCol");
            $obj->showQeditErrors = true;
            $obj->showRetrieveErrors = true;
            $obj->general_check_errors = true;
            $obj->after_save_edit = array( 'class'=>'MappingCol', 'attribute'=>'mapping_col_id', 'currmod'=>'etl', 'currstep'=>2 );
            // $obj->after_save_edit = array( 'mode'=>'qsearch', 'currmod'=>'etl', 'class'=>'MappingColTransformation', 'submit'=>true );
        } else {
            MappingColTransformationArTranslator::initData();
            MappingColTransformationEnTranslator::initData();
        }
    }
    ...
    array(
        ...
        'mapping_col_id' => array( 'SHORTNAME' => 'col',  'SEARCH' => true,  'QSEARCH' => false,  'SHOW' => true,  'AUDIT' => false,  'RETRIEVE' => false,
        ...
        'desc_ar' => array('STEP'=>2, 'SEARCH' => true,  'QSEARCH' => true,  'SHOW' => true,  'AUDIT' => false,  'RETRIEVE' => false,
        'EDIT' => true,  'QEDIT' => false,
        ...
        'desc_en' => array('STEP'=>2, 'SEARCH' => true,  'QSEARCH' => true,  'SHOW' => true,  'AUDIT' => false,  'RETRIEVE' => false,
        'EDIT' => true,  'QEDIT' => false,
