...
class EtlAutoJobAfwStructure
 {
    // token separator = §
    public static function initInstance( &$obj )
 {
        if ( $obj instanceof AutoJob ) 
 {
            ...
            // $obj->after_save_edit = array( 'class'=>'AutoJob', 'attribute'=>'xxxx_id', 'currmod'=>'etl', 'currstep'=>2 );
            $obj->after_save_edit = array( 'mode'=>'qsearch', 'currmod'=>'etl', 'class'=>'AutoJob', 'submit'=>true );
        } else {
            AutoJobArTranslator::initData();
            AutoJobEnTranslator::initData();
        }
    }
