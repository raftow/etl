...
class EtlDataTransformationAfwStructure
{
        // token separator = §
        public static function initInstance(&$obj)
        {
                if ($obj instanceof DataTransformation) {
                        ...
                        // $obj->after_save_edit = array("class"=>'DataTransformation',"attribute"=>'xxxx_id', "currmod"=>'etl',"currstep"=>2);
                        $obj->after_save_edit = array("mode" => "qsearch", "currmod" => 'etl', "class" => 'DataTransformation', "submit" => true);
                } else {
                        DataTransformationArTranslator::initData();
                        DataTransformationEnTranslator::initData();
                }
        }
