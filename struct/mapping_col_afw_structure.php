...
class EtlMappingColAfwStructure {
    // token separator = §
    public static function initInstance( &$obj ) {
        if ( $obj instanceof MappingCol )  {
			...
			$obj->editByStep      = true;
            $obj->editNbSteps     = 3;
            $obj->UNIQUE_KEY = array( 'mapping_job_id', 'source_field_name' );
			$obj->OwnedBy = array('module' => "etl", 'afw' => "MappingJob"); 
            $obj->showQeditErrors = true;
            $obj->showRetrieveErrors = true;
            $obj->general_check_errors = true;
            $obj->after_save_edit = array( 'class'=>'MappingJob', 'attribute'=>'mapping_job_id', 'currmod'=>'etl', 'currstep'=>4 );
            // $obj->after_save_edit = array( 'mode'=>'qsearch', 'currmod'=>'etl', 'class'=>'MappingCol', 'submit'=>true );
        } else {
            MappingColArTranslator::initData();
            MappingColEnTranslator::initData();
        }
    }
    ...
    array(
        ...
        'mapping_job_id' => array( 'SHORTNAME' => 'job',  'SEARCH' => true,  'QSEARCH' => false,  'SHOW' => true,  'AUDIT' => false,  'RETRIEVE' => false,
        ...
        'mappingColTransformationList' => array('STEP' =>2, 'SHOW' => true,  'FORMAT' => 'retrieve',  'ICONS' => true,  'DELETE-ICON' => true,  'BUTTONS' => true,  'SEARCH' => false,  'QSEARCH' => false,  'AUDIT' => false,  'RETRIEVE' => false,
        ...
        'desc_en' => array('STEP' =>3, 'SEARCH' => true,  'QSEARCH' => true,  'SHOW' => true,  'AUDIT' => false,  'RETRIEVE' => false,
			'EDIT' => true,  'QEDIT' => false,
