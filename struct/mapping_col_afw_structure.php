...
class EtlMappingColAfwStructure
{
    ...
    public static function initInstance(&$obj)
    {
        if ($obj instanceof MappingCol) {
            ...
            $obj->editByStep      = true;
            $obj->editNbSteps     = 3;
            $obj->UNIQUE_KEY = array('mapping_job_id', 'source_field_name', 'destination_field_name');
    ...
    array(
        ...
        'mappingColTransformationList' => array(
            'STEP' => 2,
            'SHOW' => true,
            'FORMAT' => 'retrieve',
            'ICONS' => true,
            ...
            'TYPE' => 'FK',
            'CATEGORY' => 'ITEMS',
            'ANSWER' => 'mapping_col_transformation',
            'ANSMODULE' => 'etl',
            'ITEM' => 'mapping_col_id',
            'READONLY' => true,
            'CAN-BE-SETTED' => true,
